...
if __name__=="__main__": 
    ...
    #postprocess('qso.london.z_2p1_3p5', # model name
    #        'DESIlondon_highz', # input tag  
    #        'london.rebin.sigma2.iter0', 
    #        0, 99, sigma=2.0, debug=False) 
    #
    #postprocess('qso.london.z_2p1_3p5', # model name
    #        'DESIlondon_highz', # input tag  
    #        'london.rebin.sigma1.iter0', 
    #        0, 99, sigma=1.0, debug=False) 
    ...
    #postprocess(
    #        'qso.london.z_2p1_3p5.rebin.iter4', # model name 
    #        'DESIlondon_highz.rebin.iter4', # input tag
    #        'DESIlondon_highz.rebin.iter5', # output tag 
    #        0, 99, sigma=1.5, debug=False)
    
    #postprocess(
    #        'qso.london.z_2p1_3p5.rebin.iter3', # model name 
    #        'DESIlondon_highz.rebin.iter3', # input tag
    #        'DESIlondon_highz.rebin.iter4', # output tag 
    #        100, 392, sigma=1.5, debug=False)
